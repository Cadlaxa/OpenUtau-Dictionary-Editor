...
class Russian_hhsktG2p:
    graphemes = ["", "", "", "", "-", "а", "б", "в", "г", "д", "е", "ё", "ж", "з",
            "и", "й", "к", "л", "м", "н", "о", "п", "р", "с", "т", "у",
            "ф", "х", "ц", "ч", "ш", "щ", "ъ", "ы", "ь", "э", "ю", "я"]

    phonemes = ["", "", "", "", "i", "y", "e", "a", "o", "u", "ax", "x", "ex", "p", 
    ...
    def load_pack(self):
        dict_path = P('./Assets/G2p/g2p-ru-hhskt/dict.txt')
        ...
        onnx_path = P('./Assets/G2p/g2p-ru-hhskt/g2p.onnx')
