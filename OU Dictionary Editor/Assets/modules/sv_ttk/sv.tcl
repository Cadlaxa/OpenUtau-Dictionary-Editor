...
proc config_menus {w} {
  ...
  if {$theme == "sun-valley-dark" || $theme == "amaranth_dark" || $theme == "amethyst_dark" || $theme == "burnt-sienna_dark" || $theme == "dandelion_dark"  || $theme == "denim_dark" || $theme == "fern_dark" || $theme == "lemon-ginger_dark" || $theme == "lightning-yellow_dark" || $theme == "mint_dark" || $theme == "orange_dark" || $theme == "pear_dark" || $theme == "persian-red_dark" || $theme == "pink_dark" || $theme == "salmon_dark" || $theme == "sapphire_dark" || $theme == "sea-green_dark" || $theme == "seance_dark"} {
    $w configure \
      -relief solid \
      -borderwidth 1 \
      -activeborderwidth 0 \
  ...
  } elseif {$theme == "sun-valley-light" || $theme == "amaranth_light" || $theme == "amethyst_light" || $theme == "burnt-sienna_light" || $theme == "dandelion_light"  || $theme == "denim_light" || $theme == "fern_light" || $theme == "lemon-ginger_light" || $theme == "lightning-yellow_light" || $theme == "mint_light" || $theme == "orange_light" || $theme == "pear_light" || $theme == "persian-red_light" || $theme == "pink_light" || $theme == "salmon_light" || $theme == "sapphire_light" || $theme == "sea-green_light" || $theme == "seance_light"} {
    $w configure \
      -relief solid \
      -borderwidth 1 \
      -activeborderwidth 0 \
