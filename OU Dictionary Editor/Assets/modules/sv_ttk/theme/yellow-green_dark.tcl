...
namespace eval ttk::theme::yellow-green_dark {
  package provide ttk::theme::yellow-green_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_yellow-green_dark.png]

  ttk::style theme create yellow-green_dark -parent clam -settings {
