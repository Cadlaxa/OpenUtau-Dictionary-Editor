...
namespace eval ttk::theme::dandelion_dark {
  package provide ttk::theme::dandelion_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_dandelion_dark.png]

  ttk::style theme create dandelion_dark -parent clam -settings {
