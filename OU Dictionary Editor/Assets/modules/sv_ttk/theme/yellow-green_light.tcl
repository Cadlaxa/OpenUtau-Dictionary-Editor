...
namespace eval ttk::theme::yellow-green_light {
  package provide ttk::theme::yellow-green_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_yellow-green_light.png]

  ttk::style theme create yellow-green_light -parent clam -settings {
