...
namespace eval ttk::theme::l-see-green_light {
  package provide ttk::theme::l-see-green_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_light-sg_light.png]

  ttk::style theme create l-see-green_light -parent clam -settings {
