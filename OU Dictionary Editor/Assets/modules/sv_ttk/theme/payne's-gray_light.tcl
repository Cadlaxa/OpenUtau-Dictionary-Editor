...
namespace eval ttk::theme::payne's-gray_light {
  package provide ttk::theme::payne's-gray_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_payne's-gray_light.png]

  ttk::style theme create payne's-gray_light -parent clam -settings {
