...
namespace eval ttk::theme::amaranth_dark {
  package provide ttk::theme::amaranth_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_amaranth_dark.png]

  ttk::style theme create amaranth_dark -parent clam -settings {
