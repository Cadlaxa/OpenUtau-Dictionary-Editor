...
namespace eval ttk::theme::seance_dark {
  package provide ttk::theme::seance_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_seance_dark.png]

  ttk::style theme create seance_dark -parent clam -settings {
