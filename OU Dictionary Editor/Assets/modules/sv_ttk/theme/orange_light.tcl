...
namespace eval ttk::theme::orange_light {
  package provide ttk::theme::orange_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_orange_light.png]

  ttk::style theme create orange_light -parent clam -settings {
