...
namespace eval ttk::theme::lemon-ginger_dark {
  package provide ttk::theme::lemon-ginger_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_lemon-ginger_dark.png]

  ttk::style theme create lemon-ginger_dark -parent clam -settings {
