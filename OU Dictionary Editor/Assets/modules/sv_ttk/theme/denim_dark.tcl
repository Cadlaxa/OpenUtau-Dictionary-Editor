...
namespace eval ttk::theme::denim_dark {
  package provide ttk::theme::denim_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_denim_dark.png]

  ttk::style theme create denim_dark -parent clam -settings {
