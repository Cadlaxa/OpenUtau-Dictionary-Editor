...
namespace eval ttk::theme::liver_dark {
  package provide ttk::theme::liver_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_liver_dark.png]

  ttk::style theme create liver_dark -parent clam -settings {
