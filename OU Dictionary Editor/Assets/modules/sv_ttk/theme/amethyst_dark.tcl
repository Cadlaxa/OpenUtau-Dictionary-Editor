...
namespace eval ttk::theme::amethyst_dark {
  package provide ttk::theme::amethyst_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_amethyst_dark.png]

  ttk::style theme create amethyst_dark -parent clam -settings {
