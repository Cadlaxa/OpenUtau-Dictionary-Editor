...
namespace eval ttk::theme::dandelion_light {
  package provide ttk::theme::dandelion_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_dandelion_light.png]

  ttk::style theme create dandelion_light -parent clam -settings {
