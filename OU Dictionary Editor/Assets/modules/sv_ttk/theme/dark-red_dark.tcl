...
namespace eval ttk::theme::dark-red_dark {
  package provide ttk::theme::dark-red_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_dark-red_dark.png]

  ttk::style theme create dark-red_dark -parent clam -settings {
