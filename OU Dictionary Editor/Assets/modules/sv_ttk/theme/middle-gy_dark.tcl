...
namespace eval ttk::theme::middle-gy_dark {
  package provide ttk::theme::middle-gy_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_middle-gy_dark.png]

  ttk::style theme create middle-gy_dark -parent clam -settings {
