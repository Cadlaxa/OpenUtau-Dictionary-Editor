...
namespace eval ttk::theme::sky-magenta_dark {
  package provide ttk::theme::sky-magenta_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_sky-magenta_dark.png]

  ttk::style theme create sky-magenta_dark -parent clam -settings {
