...
namespace eval ttk::theme::hunter-green_dark {
  package provide ttk::theme::hunter-green_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_hunter-green_dark.png]

  ttk::style theme create hunter-green_dark -parent clam -settings {
