...
namespace eval ttk::theme::dark-red_light {
  package provide ttk::theme::dark-red_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_dark-red_light.png]

  ttk::style theme create dark-red_light -parent clam -settings {
