...
namespace eval ttk::theme::sea-green_light {
  package provide ttk::theme::sea-green_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_sea-green_light.png]

  ttk::style theme create sea-green_light -parent clam -settings {
