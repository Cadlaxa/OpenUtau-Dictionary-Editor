...
namespace eval ttk::theme::lightning-yellow_light {
  package provide ttk::theme::lightning-yellow_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_lightning-yellow_light.png]

  ttk::style theme create lightning-yellow_light -parent clam -settings {
    ...
    ttk::style map Treeview -background {selected "#e7e7e7"} -foreground {selected "#1c1c1c"}
