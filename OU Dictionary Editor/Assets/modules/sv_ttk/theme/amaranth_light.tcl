...
namespace eval ttk::theme::amaranth_light {
  package provide ttk::theme::amaranth_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_amaranth_light.png]

  ttk::style theme create amaranth_light -parent clam -settings {
