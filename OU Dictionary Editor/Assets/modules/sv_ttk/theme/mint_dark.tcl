...
namespace eval ttk::theme::mint_dark {
  package provide ttk::theme::mint_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_mint_dark.png]

  ttk::style theme create mint_dark -parent clam -settings {
