...
namespace eval ttk::theme::beaver_dark {
  package provide ttk::theme::beaver_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_beaver_dark.png]

  ttk::style theme create beaver_dark -parent clam -settings {
