...
namespace eval ttk::theme::persian-red_dark {
  package provide ttk::theme::persian-red_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_persian-red_dark.png]

  ttk::style theme create persian-red_dark -parent clam -settings {
