...
namespace eval ttk::theme::salmon_light {
  package provide ttk::theme::salmon_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_salmon_light.png]

  ttk::style theme create salmon_light -parent clam -settings {
