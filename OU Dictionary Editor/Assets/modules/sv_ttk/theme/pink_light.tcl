...
namespace eval ttk::theme::pink_light {
  package provide ttk::theme::pink_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_pink_light.png]

  ttk::style theme create pink_light -parent clam -settings {
