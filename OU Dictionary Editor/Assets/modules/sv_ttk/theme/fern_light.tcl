...
namespace eval ttk::theme::fern_light {
  package provide ttk::theme::fern_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_fern_light.png]

  ttk::style theme create fern_light -parent clam -settings {
