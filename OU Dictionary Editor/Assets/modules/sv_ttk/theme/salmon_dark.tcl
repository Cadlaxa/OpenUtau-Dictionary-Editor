...
namespace eval ttk::theme::salmon_dark {
  package provide ttk::theme::salmon_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_salmon_dark.png]

  ttk::style theme create salmon_dark -parent clam -settings {
