...
namespace eval ttk::theme::moonstone_light {
  package provide ttk::theme::moonstone_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_moonstone_light.png]

  ttk::style theme create moonstone_light -parent clam -settings {
