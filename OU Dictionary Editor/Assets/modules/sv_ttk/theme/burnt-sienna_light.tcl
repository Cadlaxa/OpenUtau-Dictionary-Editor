...
namespace eval ttk::theme::burnt-sienna_light {
  package provide ttk::theme::burnt-sienna_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_burnt-sienna_light.png]

  ttk::style theme create burnt-sienna_light -parent clam -settings {
