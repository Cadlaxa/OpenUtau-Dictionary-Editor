...
namespace eval ttk::theme::sky-magenta_light {
  package provide ttk::theme::sky-magenta_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_sky-magenta_light.png]

  ttk::style theme create sky-magenta_light -parent clam -settings {
