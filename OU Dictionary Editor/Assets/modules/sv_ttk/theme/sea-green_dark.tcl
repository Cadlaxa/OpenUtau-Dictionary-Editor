...
namespace eval ttk::theme::sea-green_dark {
  package provide ttk::theme::sea-green_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_sea-green_dark.png]

  ttk::style theme create sea-green_dark -parent clam -settings {
