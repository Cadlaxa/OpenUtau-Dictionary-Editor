...
namespace eval ttk::theme::moonstone_dark {
  package provide ttk::theme::moonstone_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_moonstone_dark.png]

  ttk::style theme create moonstone_dark -parent clam -settings {
