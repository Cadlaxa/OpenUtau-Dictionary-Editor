...
namespace eval ttk::theme::sapphire_light {
  package provide ttk::theme::sapphire_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_sapphire_light.png]

  ttk::style theme create sapphire_light -parent clam -settings {
