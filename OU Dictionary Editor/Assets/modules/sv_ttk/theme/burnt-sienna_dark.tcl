...
namespace eval ttk::theme::burnt-sienna_dark {
  package provide ttk::theme::burnt-sienna_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_burnt-sienna_dark.png]

  ttk::style theme create burnt-sienna_dark -parent clam -settings {
