...
namespace eval ttk::theme::hunter-green_light {
  package provide ttk::theme::hunter-green_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_hunter-green_light.png]

  ttk::style theme create hunter-green_light -parent clam -settings {
