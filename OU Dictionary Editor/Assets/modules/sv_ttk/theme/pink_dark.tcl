...
namespace eval ttk::theme::pink_dark {
  package provide ttk::theme::pink_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_pink_dark.png]

  ttk::style theme create pink_dark -parent clam -settings {
