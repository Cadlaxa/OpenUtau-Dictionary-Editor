...
namespace eval ttk::theme::payne's-gray_dark {
  package provide ttk::theme::payne's-gray_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_payne's-gray_dark.png]

  ttk::style theme create payne's-gray_dark -parent clam -settings {
