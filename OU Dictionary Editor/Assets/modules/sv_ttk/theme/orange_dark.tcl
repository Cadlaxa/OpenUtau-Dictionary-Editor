...
namespace eval ttk::theme::orange_dark {
  package provide ttk::theme::orange_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_orange_dark.png]

  ttk::style theme create orange_dark -parent clam -settings {
