...
namespace eval ttk::theme::lemon-ginger_light {
  package provide ttk::theme::lemon-ginger_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_lemon-ginger_light.png]

  ttk::style theme create lemon-ginger_light -parent clam -settings {
