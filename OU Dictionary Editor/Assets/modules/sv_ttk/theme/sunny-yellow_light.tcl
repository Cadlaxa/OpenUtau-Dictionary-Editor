...
namespace eval ttk::theme::sunny-yellow_light {
  package provide ttk::theme::sunny-yellow_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_sunny-yellow_light.png]

  ttk::style theme create sunny-yellow_light -parent clam -settings {
