...
namespace eval ttk::theme::seance_light {
  package provide ttk::theme::seance_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_seance_light.png]

  ttk::style theme create seance_light -parent clam -settings {
