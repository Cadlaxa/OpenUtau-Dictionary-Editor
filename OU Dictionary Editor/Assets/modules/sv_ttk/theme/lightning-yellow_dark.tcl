...
namespace eval ttk::theme::lightning-yellow_dark {
  package provide ttk::theme::lightning-yellow_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_lightning-yellow_dark.png]

  ttk::style theme create lightning-yellow_dark -parent clam -settings {
