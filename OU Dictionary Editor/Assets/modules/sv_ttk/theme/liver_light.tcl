...
namespace eval ttk::theme::liver_light {
  package provide ttk::theme::liver_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_liver_light.png]

  ttk::style theme create liver_light -parent clam -settings {
