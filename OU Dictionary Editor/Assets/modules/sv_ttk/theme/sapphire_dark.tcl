...
namespace eval ttk::theme::sapphire_dark {
  package provide ttk::theme::sapphire_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_sapphire_dark.png]

  ttk::style theme create sapphire_dark -parent clam -settings {
