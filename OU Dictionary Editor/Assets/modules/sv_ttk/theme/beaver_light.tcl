...
namespace eval ttk::theme::beaver_light {
  package provide ttk::theme::beaver_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_beaver_light.png]

  ttk::style theme create beaver_light -parent clam -settings {
