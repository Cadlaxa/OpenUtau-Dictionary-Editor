...
namespace eval ttk::theme::amethyst_light {
  package provide ttk::theme::amethyst_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_amethyst_light.png]

  ttk::style theme create amethyst_light -parent clam -settings {
