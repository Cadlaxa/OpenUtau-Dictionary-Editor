...
namespace eval ttk::theme::fern_dark {
  package provide ttk::theme::fern_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_fern_dark.png]

  ttk::style theme create fern_dark -parent clam -settings {
