...
namespace eval ttk::theme::l-see-green_dark {
  package provide ttk::theme::l-see-green_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_light-sg_dark.png]

  ttk::style theme create l-see-green_dark -parent clam -settings {
