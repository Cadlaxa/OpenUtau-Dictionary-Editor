...
namespace eval ttk::theme::mint_light {
  package provide ttk::theme::mint_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_mint_light.png]

  ttk::style theme create mint_light -parent clam -settings {
