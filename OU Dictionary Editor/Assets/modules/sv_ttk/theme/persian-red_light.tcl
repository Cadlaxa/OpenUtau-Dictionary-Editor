...
namespace eval ttk::theme::persian-red_light {
  package provide ttk::theme::persian-red_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_persian-red_light.png]

  ttk::style theme create persian-red_light -parent clam -settings {
