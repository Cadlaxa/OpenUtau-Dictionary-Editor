...
namespace eval ttk::theme::sunny-yellow_dark {
  package provide ttk::theme::sunny-yellow_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_sunny-yellow_dark.png]

  ttk::style theme create sunny-yellow_dark -parent clam -settings {
