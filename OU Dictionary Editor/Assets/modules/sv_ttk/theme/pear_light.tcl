...
namespace eval ttk::theme::pear_light {
  package provide ttk::theme::pear_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_pear_light.png]

  ttk::style theme create pear_light -parent clam -settings {
