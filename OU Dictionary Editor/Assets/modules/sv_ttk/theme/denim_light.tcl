...
namespace eval ttk::theme::denim_light {
  package provide ttk::theme::denim_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_denim_light.png]

  ttk::style theme create denim_light -parent clam -settings {
