...
namespace eval ttk::theme::middle-gy_light {
  package provide ttk::theme::middle-gy_light
  ...
  load_images [file join [file dirname [info script]] spritesheet_middle-gy_light.png]

  ttk::style theme create middle-gy_light -parent clam -settings {
