...
namespace eval ttk::theme::pear_dark {
  package provide ttk::theme::pear_dark
  ...
  load_images [file join [file dirname [info script]] spritesheet_pear_dark.png]

  ttk::style theme create pear_dark -parent clam -settings {
